...
public class AnsiColor {
    ...
    @NotNull
    public static AnsiColor color(@NotNull final Color fg, @NotNull final Color bg) {
        return new AnsiColor(fg, bg);
    }
    ...
    @NotNull
    public static final AnsiColor RESET = new AnsiColorBuilder().reset(true).build();
